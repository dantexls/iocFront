			...
			<div class="pbtn col-xs-offset-0 .container" style="margin-top: 30px;">
				<div class="row" style="margin: 10px;" >
					...
					<div class="find_nav">
					    ...
					    <div class="find_nav_left">
					        <div class="find_nav_list" id="pagenavi1">
					            <ul>
					                <li style="margin-left: 346px;"><a style="color: white;">城市生命线管控中心</a></li>
					            </ul>
					        </div>
					    </div>
					</div>
			 	...
			 	<div class="row" style="margin: 10px;margin-top: 55px;">
					<div class="col-xs-4" onclick="switchScene('2@8a904d70608b40f901612210665e002c@0',this);" style="text-align: center;">
				...
				<div class="row" style="margin: 10px;margin-left: 70px;margin-top: 50px;">
						<div class="col-xs-2">
							<input id="startFire" class="btn btn-default btn-lg ereport_button" type="button" value="启动地下管网监控" onclick="startPipeMonitor(this)" >
						</div>
...
<script type="text/javascript">
	...
	//启动地下管网监控
	function startPipeMonitor(val){
		$.ajax({
			url : 'http://'+ip+':8082/eventMonitor/startGasMonitor',
			data : {},
			type : 'POST',
			dataType : 'JSON',
			success : function(msg) {
				var status = msg.data;
				console.log("启动地下管网监控状态："+status);
			}
		})
		settime(val);
	}
