...
<body>
	<div style="background:url(images/controlBackground2.jpg) 0px 807px;width: 1024px;height: 875px;">
	<!-- <div style="background: #f3f6fb;width: 1024px;height: 700px;"> -->
		<div id="menu" class="mypanel">
			<div class="pbtn col-xs-offset-0 .container" style="margin-top: 30px;">
				<div class="row" style="margin: 10px;">
			 	...
			 	<div class="div-border" style="width: 977px;height: 385px;margin-left: 23px;margin-top: 57px;background: white;">
				 	<div class="row second_title" style="margin-left: -55px;">
				 		<img src="images/scenes_demo.png">
				 		<h2>场景演示</h2>
				 	</div>
					<div class="row" style="margin-left: 10px;" >
						<div class="col-xs-4" onclick="switchScene('2@25@0',this,2);" style="text-align: center;width: 300px;">
							<img src="images/fire/fire2.png" style="width: 80%;">
							<h3>火灾事件</h3>
						</div>
						<div class="col-xs-4" onclick="switchScene('2@20@0',this,1);" style="text-align: center;width: 300px;margin-left: 20px;">
						...
						<div class="col-xs-4" onclick="switchScene('2@8a90e58d5f998421015f999056e50006@0',this,4);" style="text-align: center;width: 300px;margin-left: 20px;">
							<img src="images/ofo/1.jpg" style="width: 80%;">
							<h3>智慧工地</h3>
						</div>
					</div>
					<div class="row" style="margin-left: 10px;" >
						<div class="col-xs-4" onclick="switchScene('2@8a90e58d5f998421015f9990110a0005@0',this,5);" style="text-align: center;width: 300px;">
							<img src="images/ofo/1.jpg" style="width: 80%;">
							<h3>智慧环保</h3>
						</div>
						<div class="col-xs-4" onclick="switchScene('2@8a90e58d5f998421015f998fb7cf0004@0',this,6);" style="text-align: center;width: 300px;margin-left: 20px;">
							<img src="images/ofo/1.jpg" style="width: 80%;">
							<h3>智慧安监</h3>
						</div>
						<div class="col-xs-4" onclick="switchScene('2@8a90e58d5f998421015f998d20470003@0',this,7);" style="text-align: center;width: 300px;margin-left: 20px;">
							<img src="images/ofo/1.jpg" style="width: 80%;">
							<h3>智慧社区</h3>
						</div>
				 	</div>
				...
				<!-- 全局控制操作按钮 -->
			 	<div id="" class="div-border" style="display: block;width: 977px;height: 100px;margin-left: 23px;margin-top: 12px;background: white;">
				 	<div class="row second_title">
				...
				<!-- 共享单车操作按钮 -->
				<div id="ofoDiv" class="div-border" style="display:none;width: 977px;height: 155px;margin-left: 23px;margin-top: 12px;background: white;">
				 	<div class="row second_title">
				...
				<div id="fireDiv" class="div-border" style="display:none;width: 977px;height: 236px;margin-left: 23px;margin-top: 12px;background: white;">
					...
					<div class="row" style="margin: 10px;margin-left: 70px;">
						...
						<div class="col-xs-2">
							...
							<h4 style="margin-left: 3px;">公仔1拍照</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_76.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('human2',1,0,'');">
							<h4 style="margin-left: 3px;">公仔2拍照</h4>
						</div>
					</div>
				</div>
				<!-- 违章停车操作按钮 -->
				...
				<!-- 扬尘场景操作按钮 -->
				<div id="dustDiv" class="div-border" style="display:none;width: 977px;height: 160px;margin-left: 23px;margin-top: 12px;background: white;">
				 	<div class="row second_title">
				 		<img src="images/sand_table.png">
				 		<h2>扬尘场景</h2>
				 	</div>
					<div class="row" style="margin: 10px;margin-left: 70px;">
						<div class="col-xs-2">
							<img src="images/icon/icon_41.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('worksite',1,0,'');">
							<h4>工地冒烟</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_42.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('worksite',2,0,'');">
							<h4>停止冒烟</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_76.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('human6',1,0,'');">
							<h4 style="margin-left: 10px;">公仔拍照</h4>
						</div>
					</div>
				</div>
				<!-- PM2.5场景操作按钮 -->
				<div id="pmDiv" class="div-border" style="display:none;width: 977px;height: 160px;margin-left: 23px;margin-top: 12px;background: white;">
				 	<div class="row second_title">
				 		<img src="images/sand_table.png">
				 		<h2>PM2.5场景</h2>
				 	</div>
					<div class="row" style="margin: 10px;margin-left: 70px;">
						<div class="col-xs-2">
							<img src="images/icon/icon_41.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('house',1,0,'');">
							<h4>住宅楼冒烟</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_42.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('house',2,0,'');">
							<h4>停止冒烟</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_76.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('human7',1,0,'');">
							<h4 style="margin-left: 10px;">公仔拍照</h4>
						</div>
					</div>
				</div>
				<!-- 安监场景操作按钮 -->
				<div id="safetyDiv" class="div-border" style="display:none;width: 977px;height: 160px;margin-left: 23px;margin-top: 12px;background: white;">
				 	<div class="row second_title">
				 		<img src="images/sand_table.png">
				 		<h2>安监场景</h2>
				 	</div>
					<div class="row" style="margin: 10px;margin-left: 70px;">
						<div class="col-xs-2">
							<img src="images/icon/icon_55.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('tanker',1,0,'');">
							<h4>油罐车红灯</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_57.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('tanker',2,0,'');">
							<h4>油罐车蓝灯</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_76.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('human8',1,0,'');">
							<h4 style="margin-left: 10px;">公仔拍照</h4>
						</div>
					</div>
				</div>
				<!-- 智慧社区操作按钮 -->
				<div id="communityDiv" class="div-border" style="display:none;width: 977px;height: 160px;margin-left: 23px;margin-top: 12px;background: white;">
				 	<div class="row second_title">
				 		<img src="images/sand_table.png">
				 		<h2>智慧社区</h2>
				 	</div>
					<div class="row" style="margin: 10px;margin-left: 70px;">
						<div class="col-xs-2">
							<img src="images/icon/icon_52.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('dustbin',1,0,'');">
							<h4>垃圾箱翻倒</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_53.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('dustbin',2,0,'');">
							<h4>垃圾箱归位</h4>
						</div>
						<div class="col-xs-2">
							<img src="images/icon/icon_76.png" style="width: 40%;margin-left: 20px;" onclick="sendCom('human9',1,0,'');">
							<h4 style="margin-left: 10px;">公仔拍照</h4>
						</div>
					</div>
				</div>
		...
		<div style="position: fixed;bottom: -1px;width: 101%;height: 60px;margin-left: -3px;background: white;" class="div-border">
				...
				<div class="col-xs-2" style="margin-top: 10px;">
					...
					<img style="width: 40px;" src="images/icon/anniu_71.png" onclick="flip('0@-1',this)">
				</div>
				<!-- <div class="col-xs-2">
				...
				<div class="col-xs-2" style="margin-top: 10px;">
					...
					<img style="width: 40px;" src="images/icon/anniu_73.png" onclick="flip('0@1',this)">
				</div>
				<div class="col-xs-2" style="margin-top: 10px;">
