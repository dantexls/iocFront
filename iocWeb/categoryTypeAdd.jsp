                ...
                <%@ include file="newleftPage.jsp"%>
                       ...
                       <div class="m_position f18 bold">
                             ...
                             <div style=" clear:both;"></div>
                                                        ...
                                                        分类名称：<input type="text" id="typeName"/><br/>
                                                        父级分类：<input type="text" name="typeId" value="" disabled="disabled"/><br/>                       
                       <div id="addtypetree" style="background-color:#39414A">
                              <ul id="addtypelevel"></ul>
                       </div>
                       <input type="button" value="资源分类保存" onclick="saveResourceType()"/>
                      </div>
         </div>
    </div>
