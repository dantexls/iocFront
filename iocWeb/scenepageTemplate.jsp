...
<head>
    ...
    <script src="js/scene/scenepage.js" type="text/javascript"></script>
...
<iframe src="http://localhost:8080/Cm-pom/demo/map.html" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
</div>
<div id="index_div" style="position:absolute;height: 1080px; top: 0px; width:1920px; left: 0px; z-index: -1;">
<iframe src="http://localhost:8080/Cm-pom/demo/index.html" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
</div>
