		...
		<div id="menu" class="mypanel" style="">
			<div class="pbtn col-xs-offset-0 .container" style="margin-top: 30px;">
					...
					<div class="find_nav">
					    ...
					    <div class="find_nav_left">
					        <div class="find_nav_list" id="pagenavi1">
					            <ul>
					                <li style="margin-left: 346px;"><a style="color: white;">消防管控中心</a></li>
					            </ul>
					        </div>
					    </div>
					</div>
				...
				<div class="row" style="margin: 10px;margin-top: 50px;" >
					<div class="col-xs-4" onclick="switchScene('2@41@0',this);" style="text-align: center;">
						<img src="images/scenes/land.png" style="width: 80%;" >
						<h3>火灾</h3>
					</div>
