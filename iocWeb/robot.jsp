		...
		<div id="menu" class="mypanel" style="">
			<div class="pbtn col-xs-offset-0 .container" style="margin-top: 30px;">
					...
					<div class="find_nav">
					    ...
					    <div class="find_nav_left">
					        <div class="find_nav_list" id="pagenavi1">
					            <ul>
					                <li style="margin-left: 580px;"><a style="color: white;">智能语音机器人</a></li>
					            </ul>
					        </div>
					    </div>
					</div>
				...
				<div class="row" style="margin: 10px;margin-top: 50px;" >
					<div class="col-xs-4" onclick="switchScene('robot@8a904d70615565f00161c595a153011a@0',this);" style="text-align: center;">
						<img src="images/scenes/robot.png" style="width: 80%;" >
						<h3>智能语音机器人</h3>
					</div>
			 	...
			 	<!-- <div class="row" style="margin: 10px;margin-left: 70px;margin-top: 50px;">
						<div class="col-xs-2">
							<input id="startFire" class="btn btn-default btn-lg ereport_button" type="button" value="启动火灾监控" onclick="startFireMonitor(this)" >
						</div>
...
<script type="text/javascript">
	...
	if ('WebSocket' in window) {
		websocket = new WebSocket("ws://"+ip+":8080/Cm-pom/websocket");
	...
	//启动火灾监控
	function startFireMonitor(val){
		$.ajax({
			url : 'http://'+ip+':8082/eventMonitor/startFireMonitor',
			data : {},
			type : 'POST',
			dataType : 'JSON',
			success : function(msg) {
				var status = msg.data;
				console.log("启动火灾监控状态："+status);
			}
		})
		settime(val);
	}
