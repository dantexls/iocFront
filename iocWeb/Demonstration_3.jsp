		...
		<div id="menu" class="mypanel">
			<div class="pbtn col-xs-offset-0 .container" style="margin-top: 30px;">
				<div class="row" style="margin: 10px;">
			 	...
			 	<div class="div-border" style="width: 977px;height: 395px;margin-left: 23px;margin-top: 57px;background: white;">
					...
					<div class="row" style="margin-left: 10px;" >
				 	...
				 	<div class="row" style="margin-left: 10px;" >
						<div class="col-xs-4" onclick="switchScene('2@27@0',this,1);" style="text-align: center;width: 300px;">
							<img src="images/scenes/xuanchuan.png" style="width: 80%;">
							<h3>宣传资料</h3>
						</div>
					</div>
				 </div>
