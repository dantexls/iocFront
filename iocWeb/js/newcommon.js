	    ...
	    success:function(msg){
	    	...
	    	$.each(resource,function(index,val){
	    		if(val.resourceName!=""){
	                var temp;
	                if(id=="1"){
	                	temp ='<li><a href="#" onclick="callCreat(&#39<image src='+'http://'+ip+':'+port+'/'+val.resourcePath+' style=width:100%;height:100%;>&#39)"><span></span><i>'+val.resourceName+'</i></a></li>';
	                }else if(id=="2"){
	                	temp ='<li><a href="#" onclick="callCreat(&#39<video src='+'http://'+ip+':'+port+'/'+val.resourcePath+' loop=-1 autoplay=autoplay width=100% height=100%  style=object-fit:fill;>&#39)"><span></span><i>'+val.resourceName+'</i></a></li>';
	                }else {//改造后的网页
	                	temp='<li><a href="#" onclick="callCreat(&#39<iframe src='+val.resourcePath+' frameborder=0 scrolling=no height=100% width=100%></iframe>&#39)"><span></span><i>'+val.resourceName+'</i></a></li>';
	                }
		    		ul=ul+temp;
	    		}
	    	});
...
//	    				var sense=msg.data;
//	    				$.each(sense,function(index,val){
//	    					//var temp ='<a href="javascript:void(0)" onclick="creat('+val.content+')">'+(index+1)+'</a>';
//	    					var temp='<li><a href="#" onclick="callCreat('+val.content+')"><span></span><i>web资源'+(index+1)+'</i></a></li>';
//	    					thtm=thtm+temp;
//	    				});
//	    			}
//	    		});
